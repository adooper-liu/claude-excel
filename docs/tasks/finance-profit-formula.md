...
- **状态**：`done`（2026-08-29 关闭：已被 Pack 化取代，仅留档）
...
| 2026-08-29 | superseded | Codex | docs/finance-profit-formula-superseded | 关闭：master 已 Pack 化（拆除 finance-run + SKILL 附录 B 重做净利活公式并禁止 SUMIFS(item_price) 当收入），分支代码过时不并入，仅留档本 brief |
